...
env NCCL_P2P_DISABLE=0 NCCL_IB_DISABLE=0 HF_HUB_OFFLINE=1 \
  deepspeed --include localhost:0 --master_port 17621 /root/MoRE/finetune.py \
  ...
  --expert_kernel_sizes 6 6 6 6 6 6 6 6 \
  --moe_top_k 2 \
...
echo "MoRE_6666 training completed"
